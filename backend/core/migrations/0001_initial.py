# Generated by Django 5.0.2 on 2024-12-07 06:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='startups', to='core.phase')),
                ('phases', models.ManyToManyField(blank=True, null=True, related_name='startups', to='core.category')),
